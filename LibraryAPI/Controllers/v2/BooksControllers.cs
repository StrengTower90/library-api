...
namespace LibraryAPI.Controllers.v2
{
    ...
    public class BooksControllers : ControllerBase
    {
        ...
        public ActionResult RetrieveToken()
        {
            ...
            var url = Url.RouteUrl("RetrieveBooksListWithTokenV2", new { token }, "https");
            return Ok(new { url });
        }

        [HttpGet("list/{token}", Name = "RetrieveBooksListWithTokenV2")]
        [AllowAnonymous]
        ...
        [HttpGet("{id:int}", Name = "RetrieveBookV2")]
        [AllowAnonymous]
        [OutputCache(Tags = [cache])]
        ...
        public async Task<ActionResult> Post(BookCreationDTO bookCreationDTO)
        {
            ...
            return CreatedAtRoute("RetrieveBookV2", new { book.Id }, bookDTO);
        }
